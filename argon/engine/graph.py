...
from argon.utils.tokens import TokenCounter, estimate_tokens, resolve_precision_budget, PRECISION_BUDGET_PROFILES
...
class ArgonEngine:
    ...
    def _select_precision_symbols(self, graph: Dict[str, Any], task: str, max_tokens: int = 0) -> List[Dict[str, Any]]:
        def _read_snippet(sym):
            return _read_symbol_snippet_fn(self.root, self.parser, sym)
